...
# TODO: hack to prevent lpm trying to validate the downloaded packages
p404 = pmpkg('pkg404')
...
#self.addrule("LPM_RETCODE=0") # TODO
self.addrule("LPM_OUTPUT={}".format(normal_url.replace("http://", "")))
self.addrule("!LPM_OUTPUT={}".format(cache_url.replace("http://", "")))
