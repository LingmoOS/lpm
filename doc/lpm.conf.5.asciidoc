...
Description
-----------
Pacman, using linkman:libalpm[3], will attempt to read lpm.conf each time it
...
*HookDir =* /path/to/hook/dir::
	...
	+{sysconfdir}/lpm.d/hooks+.  Multiple directories can be specified with
...
*GPGDir =* /path/to/gpg/dir::
	...
	files for GnuPG. The default is +{sysconfdir}/lpm.d/gnupg/+.
...
Include = {sysconfdir}/lpm.d/pkg_sources.list
--------
