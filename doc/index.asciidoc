...
lpmoes not strive to "do everything." It will add, remove and upgrade
...
Changelog
~~~~~~~~~
For a good idea of what is going on in lpmevelopment, take a look at the
...
Mailing List
~~~~~~~~~~~~
There is a mailing list devoted to lpmevelopment, hosted by Lingmo OS.
