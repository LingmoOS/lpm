/*
 *  lpm-conf.c - parse lpm configuration files
 *
...
const char *myname = "lpm-conf", *myver = "1.0.0";
...
static void usage(int ret)
{
	...
	fputs(_("lpm-conf - query lpm's configuration file\n"), stream);
	fputs(_("usage:  lpm-conf [options] [<directive>...]\n"), stream);
	fputs(_("        lpm-conf (--repo-list|--help|--version)\n"), stream);
	fputs(_("options:\n"), stream);
