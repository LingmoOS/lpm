/*
 *  vercmp.c - Compare package version numbers using lpm's version
 *      comparison logic
 *
...
{
	fprintf(stderr, "vercmp (lpm) v" PACKAGE_VERSION "\n\n"
		"Compare package version numbers using lpm's version comparison logic.\n\n"
